...
<body>
<header>
  <h1 class="main"><a href="#" style="position: absolute;top:30px;">Kenik Spring HOme</a></h1>
  <ul>
    <li><a href="#">로그인</a></li>
    <li><a href="#">회원가입</a></li>
  </ul>
...
<script>
	$(function() {
		...
		// dept.js -> deptService.add() Ajax 새로운 부서 추가 + 처리.
		...
		/* $("#tbl-dept > tbody > tr > td > span").on("click", function(event) {
			if(confirm("정말 삭제할까요?")) {
				...
				deptService.remove(deptno, function(result) {
					if(result === 'SUCCESS') {
						$(event.currentTarget).parent("tr").remove();
					}
				});
			}
		}); */
