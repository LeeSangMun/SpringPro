...
public class ESController {
	...
	public void list(Model model, String type, String word) {
		...
		try {
			...
			for (SearchHit hit : searchHits) {
				...
				sourceMap.put("score", hit.getScore());
				list.add(sourceMap);
			}
	...
	public String add(Model model, String id, String message) {
		try {
			...
			IndexRequest request = new IndexRequest("spring").source(data, XContentType.JSON)
